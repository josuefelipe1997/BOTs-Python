...
while True:
    try:
        ...
        driver.find_element(By.XPATH, '//*[@id="exten"]').send_keys(usuario)
        driver.find_element(By.XPATH, '//*[@id="login-form"]/div[3]/div/input').send_keys(senha)
        time.sleep(0.5)
...
for key in turno.keys():
    driver.find_element(By.XPATH, f'//*[@id="tblExport"]/tbody/tr[{key}]/td[9]/a[2]').click()
    time.sleep(0.5)
    driver.find_element(By.XPATH, '//*[@id="ramal"]').clear()
    time.sleep(0.5)
    driver.find_element(By.XPATH, '//*[@id="ramal"]').send_keys(turno[key])
    time.sleep(0.5)
    driver.find_element(By.XPATH, '//*[@id="frmfuncionario"]/div/div/div/div[7]/div/button').click()
